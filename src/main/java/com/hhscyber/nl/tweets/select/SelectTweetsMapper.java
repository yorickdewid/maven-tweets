 ...
 * @author eve
 */
public class SelectTweetsMapper extends TableMapper<ImmutableBytesWritable, Put> {
...
//        context.write(new ImmutableBytesWritable(String.valueOf(reducer).getBytes()), value);
        context.write(new ImmutableBytesWritable(String.valueOf("1").getBytes()), value);
    }
